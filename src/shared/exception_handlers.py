...
def _translate_known_message(message: str) -> str:
    exact_messages = {
        ...
        "Invalid token payload": "Contenido del token inválido",
        ...
        "total_units must equal box_size * quantity_boxes": "El total de unidades debe ser igual a box_size * quantity_boxes.",
        ...
        "exclude_ids must be a comma-separated list of integers": "exclude_ids debe ser una lista de enteros separada por comas.",
        ...
        "file_path_or_url cannot be empty": "file_path_or_url no puede estar vacío.",
        "files and object_keys must have the same length": "files y object_keys deben tener la misma longitud.",
        "content_types must have the same length as files": "content_types debe tener la misma longitud que files.",
